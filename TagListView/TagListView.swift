...
//  Copyright (c) 2018 Ali Moazenzadeh. All rights reserved.
//
...
open class TagListView: UIView {
    ...
    @objc open dynamic var tagLineBreakMode: NSLineBreakMode = .byTruncatingMiddle {
        didSet {
            for tagView in tagViews {
    ...
    private func rearrangeViews() {
        ...
        for (index, tagView) in tagViews.enumerated() {
            ...
            if currentRowTagCount == 0 ||
                ...
                currentRowView.frame.origin.y = marginY
    ...
    private func createNewTagView(_ title: String) -> TagView {
        ...
        tagView.onLongPress = { [unowned self] this in
            self.tagViews.forEach { $0.isSelected = ($0 == this) }
        }
